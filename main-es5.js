...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsDisplayDisplayComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var o2_chart_lib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! o2-chart-lib */
    "./node_modules/o2-chart-lib/o2-chart-lib.umd.js");
    /* harmony import */


    var o2_chart_lib__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(o2_chart_lib__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */
    ...
    var _components_display_display_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/display/display.component */
    "./src/app/components/display/display.component.ts");
    /* harmony import */


    var _classes_conversion__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./classes/conversion */
    ...
    "./node_modules/@angular/platform-browser/fesm2015/animations.js"); // <= Add
    // <= Add
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"], _components_input_input_component__WEBPACK_IMPORTED_MODULE_11__["InputComponent"], _components_display_display_component__WEBPACK_IMPORTED_MODULE_12__["DisplayComponent"], o2_chart_lib__WEBPACK_IMPORTED_MODULE_3__["O2ChartComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_14__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_6__["MatFormFieldModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_7__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_8__["MatCardModule"]],
  ...
  /***/
  function srcAppClassesConversionTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    TreeNode = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], TreeNode);
    ...
    function () {
      ...
      _createClass(BinaryTree, [{
        key: "treeConversion",
        value: function treeConversion(temp, equation) {
          while (true) {
          ...
          while (count <= 3) {
            for (var _i = equation.length; _i >= 0; _i--) {
              if (count === 1 && (equation.charAt(_i) === '+' || equation.charAt(_i) === '-')) {
                temp = new TreeNode();
                temp.name = equation.charAt(_i);
                temp.children[0] = this.treeConversion(temp.children[0], equation.substring(0, _i));
                temp.children[1] = this.treeConversion(temp.children[1], equation.substring(_i + 1, equation.length));
                return temp;
              } else if (count === 2 && (equation.charAt(_i) === '*' || equation.charAt(_i) === '/')) {
                temp = new TreeNode();
                temp.name = equation.charAt(_i);
                ...
                temp.children[1] = this.treeConversion(temp.children[1], equation.substring(_i + 1, equation.length));
                return temp;
              } else if (count === 3 && (equation.charAt(_i) === '^' || equation.charAt(_i) === '$')) {
                temp = new TreeNode();
                temp.name = equation.charAt(_i);
                console.log(temp.name);
                temp.children[0] = this.treeConversion(temp.children[0], equation.substring(0, _i));
        ...
        key: "jsonConverter",
        value: function jsonConverter(temp) {
          if (temp === null) return "";
          var json = "{ \"name\": " + "\"" + temp.name + "\"";
  ...
  /***/
  function srcAppComponentsDisplayDisplayComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsDisplayDisplayComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var o2_chart_lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! o2-chart-lib */
    "./node_modules/o2-chart-lib/o2-chart-lib.umd.js");
    /* harmony import */


    var o2_chart_lib__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(o2_chart_lib__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var src_app_services_graph_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function DisplayComponent(chartConst, _GraphService) {
      ...
      _createClass(DisplayComponent, [{
        ...
        value: function initilizeData() {
          ...
          this._GraphService.graph$.subscribe(function (data) {
            _this.treeDataJson = data, console.log(data);
          }); // this.treeDataJson = 
          // {
          //     "name": "Eve",
          //     "children": [
    ...
    DisplayComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/display/display.component.html")).default,
      animations: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_4__["trigger"])('fade', [//state(),
      Object(_angular_animations__WEBPACK_IMPORTED_MODULE_4__["transition"])('void => *', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_4__["style"])({
        opacity: 0
      }), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_4__["animate"])(2000, Object(_angular_animations__WEBPACK_IMPORTED_MODULE_4__["style"])({
        opacity: 1
      }))])])],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./display.component.scss */
      "./src/app/components/display/display.component.scss")).default]
    })], DisplayComponent);
    /***/
  },
  ...
  function srcAppComponentsInputInputComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_classes_conversion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/classes/conversion */
    "./src/app/classes/conversion.ts");
    /* harmony import */
    ...
    var o2_chart_lib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! o2-chart-lib */
    "./node_modules/o2-chart-lib/o2-chart-lib.umd.js");
    /* harmony import */


    var o2_chart_lib__WEBPACK_IMPORTED_MODULE_5___default =
    /*#__PURE__*/
    __webpack_require__.n(o2_chart_lib__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function InputComponent(chartConst, _BinaryTree, _GraphService) {
      ...
      _createClass(InputComponent, [{
        ...
        value: function getErrorMessage() {
          return this.eqForm.controls['name'].hasError('required') ? 'You must enter a value' : this.eqForm.controls['name'].hasError('invalidChar') ? 'Equation contains invalid characters    Ex. Format: 2+5*10' : this.eqForm.controls['name'].hasError('prefixSuffixError') ? 'Equation cant start or end with an operator (+ - * / ^)   Ex. Format: 2+5*10' : this.eqForm.controls['name'].hasError('leadingZeros') ? 'Integer cannot have a leading zero   Ex. Format: 2+5*10' : this.eqForm.controls['name'].hasError('adjOperators') ? 'Cannot have adjacent operators  Ex. Format: 2+5*10' : this.eqForm.controls['name'].hasError('whiteSpace') ? 'Please enter equation without whitespace  Ex. Format: 2+5*10' : '';
        }
      }, {
        key: "eqValidator",
        value: function eqValidator(control) {
          var eq = control.value;

          for (var i = 0; i < eq.length; i++) {
            if (eq.charAt(i) == ' ') return {
              whiteSpace: {}
            };

            if (i == 0 || i == eq.length - 1) {
              if (eq.charAt(i) === '+' || eq.charAt(i) === '-') return {
                prefixSuffixError: {}
              };
              if (eq.charAt(i) === '*' || eq.charAt(i) === '/') return {
                prefixSuffixError: {}
          ...
          for (var _i2 = 0; _i2 < eq.length; _i2++) {
            if (_i2 != eq.length - 1 && eq.length != 1) {
              if (eq.charAt(_i2) === '+' || eq.charAt(_i2) === '-' || eq.charAt(_i2) === '*' || eq.charAt(_i2) === '/' || eq.charAt(_i2) === '^' || eq.charAt(_i2) === '$') {
                if (eq.charAt(_i2 + 1) === '+' || eq.charAt(_i2 + 1) === '-') return {
                  adjOperators: {}
                };
                if (eq.charAt(_i2 + 1) === '*' || eq.charAt(_i2 + 1) === '/') return {
                  adjOperators: {}
            ...
            if (_i2 === 0) {
              if (eq.charAt(_i2) === '0' && eq.length > 1 && Number(eq.charAt(_i2 + 1) || eq.charAt(_i2 + 1) === '0')) {
                return {
                  leadingZeros: {}
                };
              }
            ...
            if (eq.charAt(_i2) === '0') {
              if (eq.length > 1 && _i2 !== eq.length - 1) {
                if (eq.charAt(_i2 - 1) === '+' || eq.charAt(_i2 - 1) === '-') return {
                  leadingZeros: {}
                };
                if (eq.charAt(_i2 - 1) === '*' || eq.charAt(_i2 - 1) === '/') return {
        ...
        key: "ngOnInit",
        value: function ngOnInit() {} //Submits equation string to tree converter

      }, {
        key: "convertEq",
        value: function convertEq() {
          this.treeTypeName = this.chartConst.TREE_CHART_TYPE_NAME;
          this.node = this._BinaryTree.treeConversion(this.node, this.eqForm.controls['name'].value);
          this.initilizeData(this.node); //this.send(this.node); // ==> Sends tree object to display component
        } //Sends tree object to display component

      }, {
        key: "send",
        value: function send(treenode) {
          this._GraphService.send(treenode);
        }
      }, {
        key: "initilizeData",
        value: function initilizeData(_TN) {
          // this.configData = this.httpClient.get('assets/json/ConfigData.json');
          this.configData = {
            "className": {
              "axis": "axis",
    ...
    InputComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      animations: [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_6__["trigger"])('fade', [//state(),
      Object(_angular_animations__WEBPACK_IMPORTED_MODULE_6__["transition"])('void => *', [Object(_angular_animations__WEBPACK_IMPORTED_MODULE_6__["style"])({
        opacity: 0
      }), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_6__["animate"])(1000, Object(_angular_animations__WEBPACK_IMPORTED_MODULE_6__["style"])({
        opacity: 1
      }))])])],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/GregoryRoss1/Angular-Projects/Equation-to-Tree-Converter-master/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
